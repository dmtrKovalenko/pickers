...
import * as CustomDay from 'examples/CustomDay.example'
import * as ServerRequest from 'examples/ServerRequest.example'
import * as ViewsDatePicker from 'examples/ViewsDatePicker.example'
import * as BasicDatePicker from 'examples/BasicDatePicker.example'
import * as StaticDatePicker from 'examples/StaticDatePicker.example'
import * as DatePickers from 'examples/DatePickers.example'
import * as CustomInput from 'examples/CustomInput.example'
