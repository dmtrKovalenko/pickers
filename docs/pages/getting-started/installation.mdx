...
<PageMeta
  title="Installation"
  description="Step-by-step guide how to install @pickers/material-ui"
/>

# Installation

Material UI Pickers is available as an [npm package](https://www.npmjs.com/package/@pickers/material-ui):
...
`@pickers/material-ui` was designed to use the date management library of your choice.
...
import MomentUtils from '@pickers/material-ui/adapter/moment';
import DateFnsUtils from '@pickers/material-ui/adapter/date-fns';
import LuxonUtils from '@pickers/material-ui/adapter/luxon';
