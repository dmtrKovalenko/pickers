...
export default function Logo({ size = 200}: { size?: number }) {
  ...
  return (
    <div className={clsx("shadow shadow-md bg-primary rounded-full border-solid border-8 border-primary-dark", classes.annulateLogoPaddings)}>
      <svg
        width={size}
        height={size}
        viewBox="0 0 40 40"
